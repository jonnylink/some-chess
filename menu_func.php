...
function invite($name,$email,$friend,$domain,$homeFolder,$startPower,$menuFuncStr){
	...
	if(!$name || !$email){
		...
		$rPassword	= randomPassword('tkmF#w8EcRzW6GvOPfcgNsQD1hArU4Y$Lx2a7Mu0jT3B!q5SyXJCheInpKZbHV9',10);
...
function random_black($player1,$player2){
	$black_player = rand(0,1);
	return ($black_player==0)? $player1 : $player2;
//	if($black_player==0){return $player1;}else{return $player2;}
}
?>